package LambdaExp.chainingLambda;
...
public class Main {
    public static void main(String[] args) {
        ...
        Function<String, String> lastName = s -> s.concat("Benny");
        Function<String, String> uCaseLastName = uCase.andThen(lastName);

        uCaseLastName = uCase.compose(lastName); // runs the concat lambda first and then uppercase
